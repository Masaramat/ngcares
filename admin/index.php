                    ...
                    <div class="col-sm-4">
                        <div class="card border border-success bg-light">
                            <div class="card-body">
                                ...
                                <p class="card-text">Total users: <?php echo getUsersNO(); ?></p>
                                <a href="users/" class="btn btn-primary">Manage</a>
                            </div>
                        </div>
                    </div>
                    <div class="col-sm-4">
                        <div class="card border border-warning bg-light">
                            <div class="card-body">
                                ...
                                <a href="fcas/" class="btn btn-danger">Manage </a>
                            </div>
                        </div>
                    </div>
                    <div class="col-sm-4">
                        <div class="card border border border-success bg-light">
                            <div class="card-body">
                                ...
                                <a href="./groups/" class="btn btn-primary">Manage</a>
                            </div>
                        </div>
                    </div>
                    ...
                    <div class="col-sm-4">
                        <div class="card border border-primary bg-light">
                            <div class="card-body">
                                ...
                                <p class="card-text">Total Distributions: <?php echo getDistributionNO(); ?></p>
                                <a href="./distribution/" class="btn btn-success">Manage </a>
                            </div>
                        </div>
                    </div>
                    <div class="col-sm-4">
                        <div class="card border border border-danger bg-light">
                            <div class="card-body">
                                <h5 class="card-title">Service Providers</h5>
                                <p class="card-text">Total Service Providers: <?php echo getServiceProvidersNO(); ?></p>
                                <a href="./serviceprovider/" class="btn btn-warning">Manage</a>
                            </div>
                        </div>
                    </div>
                </div>
