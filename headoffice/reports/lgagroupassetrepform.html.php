...
<head>
<title>Group Assets Report</title>
<meta http-equiv="content-type"
content="text/html; charset=utf-8"/>
</head>
<body>
<h1>DLI 2.3: Group Assets Report (By LGA)</h1>
<p><a href=".">Back</a></p>
<form action="" method="get">
<p>View Group Assets, using the following criteria:</p>
...
<option value="<?php htmlout($enterprise['id']); ?>"> <?php htmlout($enterprise['enterprise']); ?></option>
<?php endforeach; ?>
</select>
</div>
