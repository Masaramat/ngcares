                    ...
                    <div class="col-sm-6">
                        <div class="card border border-primary bg-light">
                            <div class="card-body">
                                ...
                                <p class="card-text">Total FCAs: <?php echo 23; ?></p>
                    ...
                    <div class="col-sm-6">
                        <div class="card border border border-warning bg-light">
                            <div class="card-body">
                                ...
                                <p class="card-text">Total groups: <?php echo 23; ?></p>
                    ...
                    <div class="col-sm-6">
                        <div class="card border border-danger bg-light">
                            <div class="card-body">
                                ...
                                <p class="card-text">Total Beneficiaries: <?php echo 23; ?></p>
                    ...
                    <div class="col-sm-6">
                        <div class="card border border-success bg-light">
                            <div class="card-body">
                                ...
                                <p class="card-text">Total Distributions: <?php echo 23; ?></p>
