            ...
            <div class="container-fluid">
                ...
                <table id="users_table" class="table table-striped table-bordered nowrap table-responsive">
                    ...
                    <tbody>
                        ...
                        <tr valign="top">
                            <td><?php htmlout($fca['id']); ?></td>
                            <td><?php htmlout($fca['fca']); ?></td>
                            <td><?php htmlout($fca['lga_name']); ?></td>
                            <td><?php htmlout($fca['leader']); ?></td>
                            <td><?php htmlout($fca['phoneline']); ?></td>
                            <td>
